...
export function GoogleButton() {
  return (
    <a
      href={googleAuthUrl()}
      className="inline-flex h-10 w-full items-center justify-center gap-2.5 rounded-lg border border-border-strong bg-surface text-sm font-semibold text-fg transition-colors hover:bg-surface-2 hover:border-accent-line"
    >
      <GoogleIcon />
